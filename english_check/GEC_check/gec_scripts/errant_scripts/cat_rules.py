...
def sameLemma(orig_tok, cor_tok, nlp):
    ...
    cor_lemmas = []
    for pos in open_pos:
        # print("string[int]",nlp.vocab.morphology.strings[orig_tok.lower])
        # print(pos)
        # print(orig_tok)
        # print(type((orig_tok.lower_)))
        # Pass the lower cased form of the word for lemmatization; improves accuracy.
        # lemmatizer = Lemmatizer(nlp.vocab.lookups)
        # orig_lemmas.append(nlp.vocab.morphology.lemmatizer(pos, orig_tok.lower, nlp.vocab.morphology.tag_map))
        # cor_lemmas.append(nlp.vocab.morphology.lemmatizer(pos, cor_tok.lower, nlp.vocab.morphology.tag_map))
        # print("L:", orig_tok.lemma_)
        orig_lemmas.append(orig_tok.lemma_)
